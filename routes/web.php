...
Route::get('/admin/edit_form_general_information/{recorddata_id}/{checkup_id}', [RecorddataController::class, 'edit_form_general_information'])->name('recorddata.edit_form_general_information');
Route::put('/admin/update-general-information/{recorddata_id}/{checkup_id}', [RecorddataController::class, 'update_form_general_information'])->name('recorddata.update_form_general_information');
...
Route::delete('/custom-fields/options/{fieldId}/{optionIndex}', 
    [CustomFieldController::class, 'deleteOption'])->name('custom-fields.deleteOption');
