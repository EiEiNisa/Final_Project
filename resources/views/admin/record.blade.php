            ...
            <form action="{{ route('recorddata.search') }}" method="GET">
                <div class="form-group-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="name" class="form-control" type="search" name="name"
                                placeholder="ค้นหาชื่อ-นามสกุล" aria-label="Search">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="table-responsive">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel{{ $data->id }}"
                                                ...
                                                ยืนยันการลบ</h5>
                                            <button type="button"
                                                class="btn btn-light rounded-circle shadow-sm close-btn"
            ...
            <div class="custom-pagination mt-3 flex items-center gap-2">
                ...
                @for ($page = max(1, $currentPage - $sidePages); $page <= min($totalPages, $currentPage + $sidePages);
                    ...
                    {{-- หน้าสุดท้าย --}}
                    @if ($currentPage < $totalPages - $sidePages) @if ($currentPage < $totalPages - $sidePages - 1)
                        <span class="px-2">...</span>
                        @endif
